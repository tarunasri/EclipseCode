...
public class EventAddingTestbkp {

	private String msg = null;
	private String sever = null;

	public EventAddingTestbkp() {
	...
	public static void main(String[] args) {
		...
		String sever = "1";
		EventAddingTestbkp eventAddingTest = new EventAddingTestbkp();
	...
	public void mainHandler(String msg, String sever) {
		...
		String failObj = "10.208.0.82";
		String node = "10.208.0.82";
		String source = "10.208.0.82";
