/* $Id: RemoveUserFunctions.js,v 1.1.1.1 2006/12/14 11:38:09 gramkumar Exp $ */

//Function to validate user name
function ValidateUserName()
{
        if(document.RemoveUserForm.userName.value == "")
        {
...
function init()
{
    if(eval(document.RemoveUserForm.userName))
    {
