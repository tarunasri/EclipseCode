<!-- $Id: auditOperationStatus.jsp,v 1.1.1.1 2006/12/14 11:38:09 gramkumar Exp $ -->
...
<c:if test="${!empty failure}">
  <td height="20" align="center">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>      
      <td width="80%" class="responseText"><img src="/webclient/common/images/error_icon.gif" width="17" height="13" hspace="5" border="0"><c:out value="${failure}"/></td>
    </tr>
   </table>
  </td>
</c:if>
