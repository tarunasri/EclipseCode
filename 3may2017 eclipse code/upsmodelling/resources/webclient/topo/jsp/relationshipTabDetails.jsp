<%-- $Id: relationshipTabDetails.jsp,v 1.3 2007/10/18 06:25:06 gnanasekar Exp $ --%>
...
//if(eval(document.forms[1].groupnames.selectedIndex)+1)
if(eval(formName.groupnames.selectedIndex)+1)
{

nodeurl="/topo/objectdetails.do?name="+formName.groupnames.options[formName.groupnames.selectedIndex].value;
...
//if(eval(document.forms[1].childerenkeyslist.selectedIndex)+1)
if(eval(formName.childerenkeyslist.selectedIndex)+1)
{

nodeurl="/topo/objectdetails.do?name="+formName.childerenkeyslist.options[formName.childerenkeyslist.selectedIndex].value;
location.href = nodeurl;
}
}
function showMember()
...
//if(eval(document.forms[1].groupmembers.selectedIndex)+1)
if(eval(formName.groupmembers.selectedIndex)+1)
{

nodeurl="/topo/objectdetails.do?name="+formName.groupmembers.options[formName.groupmembers.selectedIndex].value;
location.href = nodeurl;
}
}
</script>
...
<tr height="20" class="header2bg" >
         <td width="720" class="propFormBlackText"> <fmt:message key='webclient.topo.objectdetails.tab.relationship.header'/></td>
      ...
      <tr class="even"> 
        <td width="175" class="blackBoldText" > <fmt:message key='webclient.topo.objectdetails.parentkey'/>  </td>
        <td width="210" class="blackText" > <c:choose> <c:when test="${!empty ObjectDetailsBean.map.parentKey}"> 
        ...
        <td width="175" class="blackBoldText" > <fmt:message key='webclient.topo.objectdetails.groupnames'/> </td>
        <td width="210" class="blackText" > <c:choose> <c:when test="${!empty ObjectDetailsBean.map.groupNames}"> 
          <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="NobotBorder">
            <tr> 
              <td  rowspan="2" align="left"> 
                <select name="groupnames" multiple class="formStyle">
...
><c:out value="${token}"/></option>
      ...
      <c:choose>
      <c:when test='${ObjectDetailsBean.map.isContainer == "true"}'> 
          <td width="150"  > <fmt:message key='webclient.topo.objectdetails.isgroup'/> </td>
          <td > <c:out value='${ObjectDetailsBean.map.isGroup}'/> </td>
        <c:choose>
        <c:when test='${ObjectDetailsBean.map.isGroup == "true"}'> 
    
        <td width="150" > <fmt:message key='webclient.topo.objectdetails.groupmembers'/> </td>
        <td> <c:choose> <c:when test="${!empty ObjectDetailsBean.map.groupMembers}"> 
          <table width="100%"  border="0" align="left" cellpadding="0" cellspacing="0" class="NobotBorder">
            <tr> 
              <td rowspan="2" align="left"> 
                <select name="groupmembers" size="1" multiple class="formStyle">
...
><c:out value="${token}"/></option>
      ...
      <tr class="odd"> 
        ...
        <td class="blackText" > <html-el:radio name="ObjectDetailsBean" property="isContainer" value="true"/> 
         ...
         <c:choose>
         <c:when test='${ObjectDetailsBean.map.isContainer == "true"}'> 
            <td width="150" > <fmt:message key='webclient.topo.objectdetails.childrenkeys'/> </td>
...
<%-- <fmt:message key='webclient.topo.objectdetails.childrenkeys.help'/>  --%> </td>
 ...
 <tr  class="even"> 
      ...
      <c:when test='${ObjectDetailsBean.map.isContainer == "true"}'> 
           <td width="150"  > <fmt:message key='webclient.topo.objectdetails.isgroup'/> </td>
           <td > <html-el:radio name="ObjectDetailsBean" property="isGroup" value="true"/> 
           <fmt:message key='webclient.topo.objectdetails.isgroup.yes'/> <html-el:radio  name="ObjectDetailsBean" property="isGroup" value="false"/><fmt:message key='webclient.topo.objectdetails.isgroup.no'/>  </td>
        <c:choose>
        <c:when test='${ObjectDetailsBean.map.isGroup == "true"}'> 
