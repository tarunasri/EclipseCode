<%-- $Id: snmpInterfaceTabDetails.jsp,v 1.3 2007/10/18 06:25:06 gnanasekar Exp $ --%>
...
<%--
      <tr > 
        ...
        <span ><fmt:message key='webclient.topo.objectdetails.tab.snmpinterface.header'/></span></td>
      </tr>
--%>
      <tr class="odd"> 
        <td class="blackBoldText" ><fmt:message key='webclient.topo.objectdetails.physmedia'/> </td>
        <td class="blackText" ><c:out value='${ObjectDetailsBean.map.physMedia}'/></td>
        <td class="blackBoldText" >  <fmt:message key='webclient.topo.objectdetails.physaddr'/></td>
        <td class="blackText" ><c:out value='${ObjectDetailsBean.map.physAddr}'/></td>
      </tr>

       <tr class="even"> 
        <td class="blackBoldText" > <fmt:message key='webclient.topo.objectdetails.ifspeed'/>  </td>
        <td class="blackText" ><c:out value='${ObjectDetailsBean.map.ifSpeed}'/> </td>
        <td class="blackBoldText" > <fmt:message key='webclient.topo.objectdetails.ifdescr'/></td>
        <td class="blackText" > <c:out value='${ObjectDetailsBean.map.ifDescr}'/></td>
      </tr>

      <tr class="odd"> 
        <td width="175" class="blackBoldText"> <fmt:message key='webclient.topo.objectdetails.sysoid'/> <br></td>
        <td width="210" class="blackText"> <c:out value='${ObjectDetailsBean.map.sysOID}'/></td>
        <td width="175" class="blackBoldText"> <fmt:message key='webclient.topo.objectdetails.ifindex'/> </td>
        <td width="210" class="blackText"><c:out value='${ObjectDetailsBean.map.ifIndex}'/></td>
      </tr>
...
<tr height="20" class="header2bg"   >
  ...
  <td width="20" id='<c:out value="editswipe${swaptableid}" />'  colspan="2" ><a href= "javascript:closeSwipe('<c:out value="${swaptableid}" />')"  ><img border=0 src="/webclient/common/images/edit.gif" width="14" height="15"></a></td>
      ...
      <c:if test='${ObjectDetailsBean.map.version == "v3"}'> 
      <tr class="odd"> 
        <td class="blackBoldText" > <fmt:message key='webclient.topo.objectdetails.contextname'/>
        </td>
        <td class="blackText" ><c:out value='${ObjectDetailsBean.map.contextName}'/></td>
        <td class="blackBoldText" > <fmt:message key='webclient.topo.objectdetails.username'/> 
        </td>
        <td class="blackText" > <c:out value='${ObjectDetailsBean.map.userName}'/></td>
      </tr>
      </c:if> 
<%--
      <tr > 
        <td height="20" class="header2bg" colspan="4"><fmt:message key='webclient.topo.objectdetails.tab.snmpinterface.header'/></td>
      </tr>
--%>
      <tr class="odd"> 
        <td class="blackBoldText" ><fmt:message key='webclient.topo.objectdetails.physmedia'/> </td>
      ...
      <tr class="even"> 
        <td class="blackBoldText" ><p><fmt:message key='webclient.topo.objectdetails.ifspeed'/></p> </td>
        <td class="blackText" ><c:out value='${ObjectDetailsBean.map.ifSpeed}'/> </td>
        <td class="blackBoldText" ><fmt:message key='webclient.topo.objectdetails.ifdescr'/> </td>
        <td class="blackText" ><c:out value='${ObjectDetailsBean.map.ifDescr}'/>&nbsp;</td>
      </tr>
