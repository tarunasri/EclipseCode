<%-- $Id: InvokeAlertFilterForm.jsp,v 1.4 2010/10/29 13:46:54 swaminathap Exp $ --%>
...
<%@include file="/webclient/admin/jspf/AlertFilterOperations.jspf" %>
...
<body onload="javascript:init('<c:out value="${selectedNotification}"/>')">
...
<html:form action="/AlertFilterAction" onsubmit="return submitForm()">
...
<table style="margin-bottom:10px;" width="70%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td align="left" valign="top" nowrap class="generalCurveTop" style="padding-right:10px;"><span class="generalTitle"><fmt:message key='webclient.admin.filters.addalertfilter'/></span></td>
...
<tr> 
  ...
  <tr height="30" id="msg"> 
    ...
    <td width="12%" height="25" class="text"><fmt:message key='webclient.admin.filters.message'/></td>
    <td width="87%"><html:text styleClass="formStyle" property="message"/></td>
  </tr>
...
<tr><td width="10">&nbsp;&nbsp;</td>
<td>
<table width="90%" class="notificationTable" cellspacing="0" cellpadding="2">
...
<%--  <html-el:option value="${NotificationType[actionList.key]}"><c:out value="${actionList.key}"/></html-el:option>--%>
    ...
    <td align="center">&nbsp;&nbsp; <input type=button class="button" value="&nbsp;&nbsp;>>&nbsp;&nbsp;" onclick="addNotification()"/>&nbsp;&nbsp;&nbsp;&nbsp;<br>
             <br>&nbsp;&nbsp; <input type=button class="button" value="&nbsp;&nbsp;<<&nbsp;&nbsp;" onclick="removeNotification()"/>&nbsp;&nbsp&nbsp;&nbsp;
    </td>    
...
<td width="20%" valign="top" align="right">
  ...
  <html-el:hidden name="AddAlertFilterForm" property="rowCount"/>
      
  <c:choose>
     <c:when test="${AddAlertFilterForm.map.rowCount == 0}">    
   ...
   <c:if test="${AddAlertFilterForm.map.rowCount != 0}">      
       ...
       <c:forEach begin="0" end="${AddAlertFilterForm.map.rowCount-1}" varStatus="status"> 
       <tr height="30"> 
       <td>&nbsp;</td>
       <td height="24" class="text"> <html-el:text property="userPropsName" styleClass="formStyle" value="${AddAlertFilterForm.map.userPropsName[status.index]}"/></td>
      <td><html-el:text property="userPropsValue" styleClass="formStyle" value="${AddAlertFilterForm.map.userPropsValue[status.index]}"/></td>
       </tr>
       </c:forEach>       
...
<table width="70%" border="0" cellspacing="0" cellpadding="0">
  <tr > 
    ...
    <input type="button" class="button" value="<fmt:message key='webclient.admin.filters.cancelbutton'/>" onclick="javascript:location.href='/admin/AlertFilters.do';"/> </td>
    </td>
  </tr>
</table>
</td>
