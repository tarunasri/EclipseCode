<%-- $Id: SaveEventFilterForm.jsp,v 1.1.1.1 2006/12/14 11:38:09 gramkumar Exp $ --%>
...
<html>
<head><title><fmt:message key='webclient.admin.filters.savealertfilter'/></title></head>

<%@include file="/webclient/admin/jspf/NotificationOperations.jspf" %>

<html:form action="/SaveEventFilterAction" onsubmit="return validate()">
    <table border=0 class="dbborder1" cellspacing="0" cellpadding="2" width="100%" align="center">

        <tr height=25 class="header2Bg">
            <td colspan="2" align="center" valign="middle" class="boldText" nowrap><fmt:message key='webclient.admin.filters.saveto'/></td>
        </tr>
        ...
        <tr class="reportsOddRow" height="30">
            <td align="right"><input type="submit" class="button" value="<fmt:message key='webclient.admin.filters.savebutton'/>"/></td>
