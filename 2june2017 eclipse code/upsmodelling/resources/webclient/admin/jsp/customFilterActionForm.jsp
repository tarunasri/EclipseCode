<%-- $Id: customFilterActionForm.jsp,v 1.5 2010/10/29 13:46:54 swaminathap Exp $ --%>
...
<html>
<head>
<title><fmt:message key='webclient.admin.notifications.configure'/> <fmt:message key='webclient.admin.notifications.customfilteraction'/></title>
</head>
...
<html:form action="/ConfigureCustomFilterAction" onsubmit="return validateCFForm()">
...
<tr height=25 class="header2Bg"><td colspan="2" align="center" valign="middle" class="boldText" nowrap><fmt:message key='webclient.admin.notifications.configure'/> <fmt:message key='webclient.admin.notifications.customfilteraction'/></td></tr>
...
<td width="50%" align="left"><span class="boldText"><fmt:message key='webclient.admin.notifications.userclass'/></span></td>
<td align="center"><html:text styleClass="formStyle" property="ClassName"/></td>
</tr>
