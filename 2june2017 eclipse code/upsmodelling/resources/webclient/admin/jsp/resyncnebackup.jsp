<%-- $Id: resyncnebackup.jsp,v 1.3 2007/10/16 13:08:37 gnanasekar Exp $ --%>
...
<input type="hidden" name="toPerform" value="resyncNEsWithBackup" >
...
<c:otherwise>
  ...
  <table align="center" class="messageStyle" width="60%" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr> 
      <td align="center" valign="top" class="text"><fmt:message key='webclient.admin.systemadmin.resyncne.withbackup.text'/><br>
<br>
