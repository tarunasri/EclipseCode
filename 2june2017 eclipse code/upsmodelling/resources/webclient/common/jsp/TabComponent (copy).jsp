	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top" colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="toplinks" valign="top" align="right" nowrap style="padding-top:2px;" ><span style="padding-left:45px;" class="boldTxt"><a href="/Support.do?supportlink=yes">
                  <fmt:message key='webclient.common.support.link'/>
                  </a></span> | <a href="javascript:openWindow('/ChangePassword.do','ChangePassword','430','280')">
